...
# from src.SentimentTreesManager import SentimentTreesManager
import src.SentimentTreesManager
...
class UtilityFunctions(object):
    ...
    def split_string_with_multiple_tokenizers(self, text, tokenizers = None, path = "../data/tokenisers.txt"):
        ...
        if not tokenizers and path:
            ...
            # self.tokenizers = DBComm.read_sentiment_tokenizers_from_db()
    ...
    def score_individual_piece_of_text(self ,text = None, sentiment_trees = None):
        ...
        for clause in text:
            ...
            for tree in sentiment_trees:
                ...
                if src.SentimentTreesManager.SentimentTreesManager.has_unchecked_descendants(tree): # if tree has an unchecked descendant
                    unchecked_ultimate_descendants = src.SentimentTreesManager.SentimentTreesManager.get_unchecked_ultimate_descendants(tree)
